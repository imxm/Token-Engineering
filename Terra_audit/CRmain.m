...
current_baseVirtualPool = 10000; % Single value for baseVirtualPool
...
results_total_reserves = cell(numSimulations, 1);
...
for s = 1:numSimulations
    ...
    sim = AlgorithmicStablecoinSimulation(T_a, T_b, initialT_bPrice, totalT_a, totalT_b, freeT_a, freeT_b, current_baseVirtualPool, current_poolRecoveryPeriod, numberOfIterations, walletExpRate, poolFee, current_sigma, TotalReserves);
    
    % Store results
    [results_P_a{s}, results_P_b{s}, results_probA{s}, results_probB{s}, results_delta{s}, results_totalT_aSupply{s}, results_totalT_bSupply{s}, results_freeT_a{s}, results_freeT_b{s}, results_total_reserves{s}] = sim.runSimulation();
...
save('simulation_results_newfile.mat', 'results_P_a', 'results_P_b', 'results_probA', 'results_probB', 'results_delta', 'results_totalT_aSupply', 'results_totalT_bSupply', 'results_freeT_a', 'results_freeT_b', 'current_sigma', 'current_poolRecoveryPeriod', 'current_baseVirtualPool', 'numSimulations', 'numberOfIterations');
