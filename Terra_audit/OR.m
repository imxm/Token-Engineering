...
save('simulation_results_simplified.mat', 'results_P_a', 'results_P_b', 'results_probA', 'results_probB', 'results_delta', 'results_totalT_aSupply', 'results_totalT_bSupply', 'results_freeT_a', 'results_freeT_b', 'current_sigma', 'current_poolRecoveryPeriod', 'current_baseVirtualPool', 'numSimulations', 'numberOfIterations');
